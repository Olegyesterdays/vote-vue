...
export const accountModule = {
  ...
  getters: {
    ...
    getLinkToMyNextVotes(state) {
      return state.linkToMyNextVotes
    },

    // notPassed =======================================================================================================
    getNotPassed(state) {
      return state.notPassed
    },

    getLinkToMyNextNotPassedVotes(state) {
      return state.linkToMyNextNotPassedVotes
    },
    ...
    getLinkToMyNextPassedVotes(state) {
      return state.linkToMyNextPassedVotes
    }
  },
    ...
    myCreated({ commit }) {
      api
        ...
        .then(response => {
          ...
          commit('linkToMyNextVotes', {
            link: response.data.pagination.next_page
          })
        })
    ...
    onlyNotCompleted({ commit }) {
      api
        ...
        .then(response => {
          ...
          commit('linkToMyNextNotPassedVotes', {
            link: response.data.pagination.next_page
          })
        })
    ...
    onlyCompleted({ commit }) {
      api
        ...
        .then(response => {
          ...
          commit('linkToMyNextPassedVotes', {
            link: response.data.pagination.next_page
          })
        })
